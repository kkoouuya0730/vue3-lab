      ...
      >
        ...
        <div class="flex align-items-center gap-2">
          <PrButton
            ...
            @click="switchMode"
            text
            :disabled="isLoading || mode === MODE.SIGNUP"
            class="p-1 text-primary-50 border-1 border-white-alpha-30 hover:bg-white-alpha-10"
          ></PrButton>
          /
          <PrButton
            label="Sign-In"
            @click="switchMode"
            text
            :disabled="isLoading || mode === MODE.SIGNIN"
            class="p-1 text-primary-50 border-1 border-white-alpha-30 hover:bg-white-alpha-10"
          ></PrButton>
        </div>
      </div>
